...
def page_not_found_view(
    ...
    return render(request,
                  template_name,
                  {'message': 'Oops, the address you visited ' + url + 'is an unknown place. Please click on the home '
                                                                       'page to see other?',
                   'statuscode': '404'},
                  status=404)
...
def server_error_view(request, template_name='blog/error_page.html'):
    return render(request,
                  template_name,
                  {'message': 'Oops, something went wrong, I have already collected the error information, '
                              'I will rush to repair it later, please click on the home page to see other?',
                   'statuscode': '500'},
                  status=500)
...
def permission_denied_view(
    ...
    return render(
        request, template_name, {
            'message': 'Oops, you don`t have permission to access this page, please click the home page to see '
                       'something else?', 'statuscode': '403'}, status=403)
